            ...
            if (chartRef2.current) {
                chart2 = new ChartJS(chartRef2.current, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [15, 30, 25, 30],
                            backgroundColor: ['#10b981', '#3b82f6', '#f59e0b', '#71717a'],
                            borderWidth: 0
                        }]
                    },
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        ...
                        <div className="card p-6">
                            ...
                            <div className="text-3xl font-light text-zinc-100">24</div>
                            <div className="text-emerald-500 text-xs mt-2 flex items-center gap-1">
                                <div className="icon-arrow-up text-[10px]"></div> 8 new this week
                            </div>
                        </div>
                    </div>
